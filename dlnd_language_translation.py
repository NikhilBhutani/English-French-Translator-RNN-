...
def text_to_ids(source_text, target_text, source_vocab_to_int, target_vocab_to_int):
    ...
    #print(target_text)
    #print(target_text.replace("\n", " ").replace(".", "<EOS>").split(" "))
    #target = target_text.replace("\n", " ").replace(".", "<EOS>").split(" ")
    target_id_text = [[target_vocab_to_int[word] for word in sentence.replace(".", ". <EOS>").split()] for sentence in target_text.split("\n")]
...
def sentence_to_seq(sentence, vocab_to_int):
    ...
    for i, word in enumerate(sentence.split()):
        ...
        if (word in vocab_to_int):
            ...
            sentence_to_int.append(vocab_to_int["<UNK>"])
